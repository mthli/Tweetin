...
public class RetweetTask extends AsyncTask<Void, Integer, Boolean> {
    ...
    public RetweetTask(Activity activity, TweetAdapter tweetAdapter, Tweet tweet) {
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            tweet.setRetweetedByName(activity.getString(R.string.tweet_info_retweeted_by_me));
