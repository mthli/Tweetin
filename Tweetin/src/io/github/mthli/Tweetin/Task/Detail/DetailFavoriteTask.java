...
public class DetailFavoriteTask extends AsyncTask<Void, Integer, Boolean> {
    ...
    protected void onPreExecute() {
        ...
        builder.setTicker(
                detailActivity.getString(R.string.tweet_notification_add_favorite_ing)
        );
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            builder.setSmallIcon(R.drawable.ic_tweet_notification);
            builder.setTicker(
                    detailActivity.getString(R.string.tweet_notification_add_favorite_successful)
            );
            builder.setContentTitle(
                    detailActivity.getString(R.string.tweet_notification_add_favorite_successful)
            );
            ...
            builder.setSmallIcon(R.drawable.ic_tweet_notification);
            builder.setTicker(
                    detailActivity.getString(R.string.tweet_notification_add_favorite_failed)
            );
            builder.setContentTitle(
                    detailActivity.getString(R.string.tweet_notification_add_favorite_failed)
            );
